...
class QuestList():
    ...
    def __getQuestTables(self, cursor, dictCursor):
        ...
        #"SELECT entry, MinLevel, QuestLevel, Type, RequiredClasses, RequiredRaces, RepObjectiveFaction, RepObjectiveValue, QuestFlags, PrevQuestId, NextQuestId, NextQuestInChain, ExclusiveGroup, Objectives, ReqItemId1, ReqItemId2, ReqItemId3, ReqItemId4, ReqSourceId1, ReqSourceId2, ReqSourceId3, ReqSourceId4, ReqCreatureOrGOId1, ReqCreatureOrGOId2, ReqCreatureOrGOId3, ReqCreatureOrGOId4, ReqSpellCast1, ReqSpellCast2, ReqSpellCast3, ReqSpellCast4, PointMapId, PointX, PointY, StartScript, CompleteScript, SrcItemId, ZoneOrSort, SpecialFlags FROM quest_template
        quest_template = []
